...
<p>
Additonally, to access the WebLogic VM created in this example add your <i>public ssh key</i> to the Terraform config variable <b>ssh_public_key</b> on <a href="terraform/vars.tf#L49">line 49</a> and then access the vm after the Terraform job has completed using the public ip address of the vm e.g.
